...
export class Board {
    ...
    /**
     * Конвертирует текущее состояние доски в строку в нотации FEN.
     * 'w' - белая шашка, 'W' - белая дамка.
     * 'b' - черная шашка, 'B' - черная дамка.
     * Цифры обозначают количество пустых клеток подряд.
     */
    public toFen(): FEN {
        let fen = '';
        for (let r = 0; r < 8; r++) {
    ...
    /**
     * Загружает позицию на доску из строки в нотации FEN.
     */
    ...
    /**
     * Устанавливает начальную позицию для игры в русские шашки.
     */
